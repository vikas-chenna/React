...
// function Card(props) {   props.username,props.btnText
function Card({username,btnText="Default Learn More"}) {
  return (
    <>
     <div className="md:max-w-sm w-full p-6 m-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
